...
export const seedAnalysisSessions: AnalysisSession[] = [
  baseSession({
    ...
    title: 'CuFe₂O₄/SBA-15 XRD Analysis',
    technique: 'xrd',
  ...
  baseSession({
    ...
    title: 'CuFe₂O₄ Spinel Raman Mode Review',
    technique: 'raman',
...
const baseProjectEvidence: ProjectEvidenceEntry[] = [
  ...
  {
    evidenceId: 'evidence-cu-raman',
    projectId: 'cu-fe2o4-spinel',
    sourceAnalysisId: 'ANL-2024-000125',
    technique: 'raman',
    fileName: 'CuFe2O4_Spinel_raman_01.txt',
    source: 'Project Lab',
    attachedAt: '4h ago',
    owner: 'Netnapong',
    status: 'saved',
    interpretationSummary: 'Mode pattern consistent with spinel-like local symmetry; A₁g and T₂g features visible.',
  },
  {
    evidenceId: 'evidence-ni-xps',
    projectId: 'nife2o4',
    ...
    owner: 'teammate',
    status: 'needs-review',
    interpretationSummary: 'Surface scan supports mixed oxide surface chemistry; Cu and Fe envelopes visible but component fitting not complete.',
  },
];
