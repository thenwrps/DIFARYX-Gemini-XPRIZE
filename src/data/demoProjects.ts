...
export const demoProjects: DemoProject[] = [
  {
    ...
    evidenceSources: [
      { technique: 'XRD', datasetId: 'xrd-cufe2o4-clean', datasetLabel: 'CuFe₂O₄ clean XRD', description: 'XRD Science Skill: Eight diffraction reflections at 18.3–62.7° 2θ match CuFe₂O₄ spinel reference positions; strongest reflection at 35.5° (311).', available: true },
    ...
    summary:
      'XRD Science Skill execution identified 8 diffraction peaks. The observed pattern provides a reference-supported phase indication for CuFe₂O₄ spinel, but represents a validation-limited scientific claim pending surface oxidation-state checks.',
    xrdPeaks: [
      { position: 18.3, intensity: 22, label: '(111)' },
      { position: 30.1, intensity: 58, label: '(220)' },
      { position: 35.5, intensity: 100, label: '(311)' },
      { position: 37.1, intensity: 10, label: '(222)' },
      { position: 43.2, intensity: 47, label: '(400)' },
      { position: 53.6, intensity: 29, label: '(422)' },
      { position: 57.1, intensity: 39, label: '(511)' },
      { position: 62.7, intensity: 46, label: '(440)' },
    ],
    evidence: [
